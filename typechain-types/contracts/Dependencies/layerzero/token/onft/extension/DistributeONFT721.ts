...
export declare namespace DistributeONFT721 {
  export type TokenDistributeStruct = {
    index: PromiseOrValue<BigNumberish>;
    value: PromiseOrValue<BigNumberish>;
  };

  export type TokenDistributeStructOutput = [BigNumber, BigNumber] & {
    index: BigNumber;
    value: BigNumber;
  };
}

export interface DistributeONFT721Interface extends utils.Interface {
  functions: {
    ...
    "distributeTokens(uint16,(uint256,uint256)[],address,address)": FunctionFragment;
    "dstChainIdToBatchLimit(uint16)": FunctionFragment;
    "dstChainIdToTransferGas(uint16)": FunctionFragment;
    "estimateDistributeFee(uint16,(uint256,uint256)[],bool)": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [
      ...
      DistributeONFT721.TokenDistributeStruct[],
...
export interface DistributeEventObject {
  _srcChainId: number;
  tokenDistribute: DistributeONFT721.TokenDistributeStructOutput[];
}
export type DistributeEvent = TypedEvent<
  [number, DistributeONFT721.TokenDistributeStructOutput[]],
...
export interface ReceiveDistributeEventObject {
  _srcChainId: number;
  _srcAddress: string;
  tokenDistribute: DistributeONFT721.TokenDistributeStructOutput[];
}
export type ReceiveDistributeEvent = TypedEvent<
  [number, string, DistributeONFT721.TokenDistributeStructOutput[]],
  ReceiveDistributeEventObject
>;

export type ReceiveDistributeEventFilter =
  TypedEventFilter<ReceiveDistributeEvent>;
...
export interface SetDistributeBaseDstGasEventObject {
  _distributeBaseDstGas: BigNumber;
}
export type SetDistributeBaseDstGasEvent = TypedEvent<
  [BigNumber],
  SetDistributeBaseDstGasEventObject
>;

export type SetDistributeBaseDstGasEventFilter =
  TypedEventFilter<SetDistributeBaseDstGasEvent>;

export interface SetDistributeGasPerIdxEventObject {
  _distributeGasPerIdx: BigNumber;
}
export type SetDistributeGasPerIdxEvent = TypedEvent<
  [BigNumber],
  SetDistributeGasPerIdxEventObject
>;

export type SetDistributeGasPerIdxEventFilter =
  TypedEventFilter<SetDistributeGasPerIdxEvent>;
...
export interface DistributeONFT721 extends BaseContract {
  ...
  functions: {
    ...
    distributeTokens(
      ...
      _tokenDistribute: DistributeONFT721.TokenDistributeStruct[],
    ...
    getDistributeTokens(
      ...
      overrides?: CallOverrides
    ): Promise<[DistributeONFT721.TokenDistributeStructOutput[]]>;
    ...
    setDistributeBaseDstGas(
      _distributeBaseDstGas: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    setDistributeGasPerIdx(
      _distributeGasPerIdx: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    ): SetDistributeBaseDstGasEventFilter;
    SetDistributeBaseDstGas(
      _distributeBaseDstGas?: null
    ): SetDistributeBaseDstGasEventFilter;
    ...
    ): SetDistributeGasPerIdxEventFilter;
    SetDistributeGasPerIdx(
      _distributeGasPerIdx?: null
    ): SetDistributeGasPerIdxEventFilter;
