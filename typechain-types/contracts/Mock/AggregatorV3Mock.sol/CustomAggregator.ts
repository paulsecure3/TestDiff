...
export interface CustomAggregatorInterface extends utils.Interface {
  functions: {
    ...
    "uniswapOracle()": FunctionFragment;
...
export interface CustomAggregator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CustomAggregatorInterface;
  ...
  functions: {
    ...
    uniswapOracle(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    uniswapOracle(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    uniswapOracle(overrides?: CallOverrides): Promise<PopulatedTransaction>;
