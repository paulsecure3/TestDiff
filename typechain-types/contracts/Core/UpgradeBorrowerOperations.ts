...
export interface UpgradeBorrowerOperationsInterface extends utils.Interface {
  functions: {
...
export interface UpgradeBorrowerOperations extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UpgradeBorrowerOperationsInterface;
