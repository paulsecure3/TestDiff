...
export interface USDATokenTestInterface extends utils.Interface {
  functions: {
  ...
  events: {
    "AdminContractSetup(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "AdminContractSetup"): EventFragment;
...
export interface AdminContractSetupEventObject {
  adminContract: string;
}
export type AdminContractSetupEvent = TypedEvent<
  [string],
  AdminContractSetupEventObject
>;

export type AdminContractSetupEventFilter =
  TypedEventFilter<AdminContractSetupEvent>;
...
export interface USDATokenTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: USDATokenTestInterface;
  ...
  filters: {
    "AdminContractSetup(address)"(
      adminContract?: null
    ): AdminContractSetupEventFilter;
    AdminContractSetup(adminContract?: null): AdminContractSetupEventFilter;
