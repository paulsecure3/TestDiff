...
contract AGLParameters is IAGLParameters, OwnableUpgradeable, CheckContract {
    ...
    uint256 public constant USDA_GAS_COMPENSATION_DEFAULT = 30 ether;
    ...
    mapping(address => uint256) public override USDA_GAS_COMPENSATION; // Amount of USDA to be locked in gas pool on opening troves
    mapping(address => uint256) public override MIN_NET_DEBT; // Minimum amount of net USDA debt a trove must have
    ...
    mapping(address => uint256) public override usdaMintCap;
    ...
    uint256 public constant REDEMPTION_MAX_FEE_DEFAULT =
        (DECIMAL_PRECISION / 1000) * 100; // 10%
    ...
    function _setAsDefault(address _asset) private {
        ...
        USDA_GAS_COMPENSATION[_asset] = USDA_GAS_COMPENSATION_DEFAULT;
    ...
    function setCollateralParameters(
        ...
        setUSDAGasCompensation(_asset, gasCompensation);
        ...
        safeCheck("Borrowing Fee Floor", _asset, borrowingFeeFloor, 0, 1000) /// 0% - 10%
    {
        ...
        uint256 newBorrowingFee = (DECIMAL_PRECISION / 10000) *
            borrowingFeeFloor;
        ...
        safeCheck("Max Borrowing Fee", _asset, maxBorrowingFee, 0, 1000) /// 0% - 10%
    {
        ...
        uint256 newMaxBorrowingFee = (DECIMAL_PRECISION / 10000) *
            maxBorrowingFee;
    ...
    function setUSDAGasCompensation(
        address _asset,
        uint256 gasCompensation
    )
        public
    ...
    {
        uint256 oldGasComp = USDA_GAS_COMPENSATION[_asset];
        USDA_GAS_COMPENSATION[_asset] = gasCompensation;
        ...
        safeCheck("Max Redemption Fee", _asset, redemptionFeeFloor, 0, 1000) /// 0% - 10%
    {
        ...
        uint256 newRedemptionFee = (DECIMAL_PRECISION / 10000) *
            redemptionFeeFloor;
    ...
    function setUSDAMintCap(
        address _asset,
        uint256 _cap
    ) external override onlyOwner {
        usdaMintCap[_asset] = _cap;

        emit USDAMintCapChanged(_asset, _cap);
    }
